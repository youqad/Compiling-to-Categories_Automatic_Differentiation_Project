...
compose (ok_pair ok_float ok_float) (ok_pair ok_float ok_float) ok_float addC
  (fork (ok_pair ok_float ok_float) ok_float ok_float
    (compose (ok_pair ok_float ok_float) (ok_pair ok_float ok_float) ok_float mulC
      (fork (ok_pair ok_float ok_float) ok_float ok_float (exl ok_float ok_float)
        (exl ok_float ok_float)))
    (compose (ok_pair ok_float ok_float) (ok_pair ok_float ok_float) ok_float mulC
      (fork (ok_pair ok_float ok_float) ok_float ok_float (exr ok_float ok_float)
