        ...
        (compose ok_float (ok_pair (ok_arrow ok_float ok_float) ok_float) ok_float
          ...
          (fork ok_float (ok_arrow ok_float ok_float) ok_float
            (curry ok_float ok_float ok_float
              (compose (ok_pair ok_float ok_float) ok_float ok_float cosC (exr ok_float ok_float)))
            (id ok_float)))))
    (compose ok_float (ok_pair (ok_arrow ok_float ok_float) ok_float) ok_float
      (apply ok_float ok_float)
      (fork ok_float (ok_arrow ok_float ok_float) ok_float
        (curry ok_float ok_float ok_float
          (compose (ok_pair ok_float ok_float) ok_float ok_float sinC (exr ok_float ok_float)))
        (id ok_float))))
)
end
